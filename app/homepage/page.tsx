...
export default function Homepage() {
  const fakeGridTiles = [
    {
      id: 0,
      src: "/assets/products/tiger.png",
      alt: "T-shirt blanc simple",
      stock: 29,
    ...
    {
      id: 1,
      src: "/assets/products/animal.png",
      alt: "Chaussure de running",
      stock: 29,
